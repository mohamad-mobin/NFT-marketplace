<template>
    <div class="container mx-auto px-10 mt-16">
        <div>
            <h1 class="text-white text-3xl">How it works</h1>
            <p class="text-gray-300">Find out how to get started</p>
        </div>
     ...
     data-aos-anchor-placement="top-bottom" class="bg-[#3b3b3b]  w-full rounded-2xl h-[330px] lg:h-fit pb-5 px-5 md:w-64">
                ...
                <div>
                    <p class="text-center text-white pb-2">Setup Your wallet</p>
            ...
            <div      data-aos-anchor-placement="top-bottom" class="bg-[#3b3b3b] w-full rounded-2xl h-[330px] lg:h-fit pb-5 px-5 md:w-64">
                ...
                <p class="text-center text-white pb-2">Start Earning</p>
                <p class="text-center text-sm text-gray-400">Choose between auctions and fixed-price listings. Start earning by selling your NFTs or trading others.</p>
            </div>
