<template>
    <div class="h-[600px] relative w-full object-cover  mt-32">
        
        <img draggable="false" class="w-full lg:block hidden h-full object-cover absolute" src="../assets/images/Mushroom.png" alt="">
        <img draggable="false" class="w-full lg:hidden hidden md:block h-full absolute" src="../assets/images/MushroomTablet.png" alt="">
        <img draggable="false" class="w-full block md:hidden h-full object-cover absolute" src="../assets/images/MushroomMobile.png" alt="">
        

        <img draggable="false" class="w-full h-full inset-0 object-cover absolute" src="../assets/images/overlay.png" alt="">


        <div class="absolute flex md:flex-row flex-col justify-center md:justify-between gap-y-10 md:items-end md:pb-20 px-20 w-full h-full">
            <div>
                <div class="bg-[#2B2B2B] text-white w-fit flex items-center gap-2 py-3 px-6 rounded-3xl">
                    <img src="../assets/images/trending-collection-images/trending7.png" alt="">
                    <span>Shroomie</span>
                </div>
                <h1 class="text-4xl py-7 text-white font-semibold">Magic Mashrooms</h1>

                <router-link :to="{ name:'marketplace' }" class="bg-white py-4 px-11 flex gap-3 items-center rounded-2xl w-fit">
                    <span>
                    ...
                    <span class="font-semibold">See NFT</span>
                </router-link>
              ...
              <div class="h-40 w-60 md:w-72 bg-[#2B2B2B]/40 backdrop-blur-md rounded-2xl text-white flex flex-col justify-center items-center gap-3 p-4">
                    <p class="text-sm opacity-80 pr-10" style="font-family: spaceMono;">Auction ends in:</p>

                    <div class="flex items-center gap-2 text-2xl font-bold">
                    <span class="text-4xl">{{ hours.toString().padStart(2, "0") }}</span>
                    <span>:</span>
                    <span class="text-4xl">{{ minutes.toString().padStart(2, "0") }}</span>
                    <span>:</span>
                    <span class="text-4xl">{{ seconds.toString().padStart(2, "0") }}</span>
                    </div>
