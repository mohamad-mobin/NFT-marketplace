        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
            ...
            <router-link data-aos="flip-down" :to="{ name:'nftPage' }" class="w-full">
                        ...
                        <div class="w-full bg-[#3b3b3b] py-4 px-5 rounded-bl-2xl rounded-br-2xl text-white">
                            <p>Life On Edena</p>
                            <div class="flex gap-2 pt-1">
                                <img class="size-5" src="../assets/images/discover-images/discoverAvatar2.png" alt="">
                                <p class="text-sm" style="font-family: spaceMono;">NebulaKid</p>
                            </div>
                            <div class="flex justify-between pt-5">
                                <div>
                                    <p style="font-family: spaceMono;" class="text-gray-400 text-sm">Price</p>
            ...
            <div class="w-full bg-[#3b3b3b] py-4 px-5 rounded-bl-2xl rounded-br-2xl text-white">
                <p>AstroFiction</p>
                <div class="flex gap-2 pt-1">
                    <img class="size-5" src="../assets/images/discover-images/discoverAvatar3.png" alt="">
                    <p class="text-sm" style="font-family: spaceMono;">Spaceone</p>
                </div>
                <div class="flex justify-between pt-5">
                    <div>
                        <p style="font-family: spaceMono;" class="text-gray-400 text-sm">Price</p>
